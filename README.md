...
### 1.	Fitting model:
At is shown in Figure 3, “s.temp”and “h.temp” having wiggle relationship with our response variable, therefore, we will fit these explanatory variables using the non-parametric smoother _**s()**_. 
